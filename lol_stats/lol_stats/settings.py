...
SECRET_KEY = 'django-insecure-@n8ffp27t(%iapyx#zwtcuj3$l#xhq(o$89cwgvw^(!dj2+!)-'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes', 'django.contrib.sessions', 'django.contrib.messages',
                  'django.contrib.staticfiles', 'graphene_django', 'champion', 'graphene_mongo', 'corsheaders']
...
pwd = "lol_stats_pass"
port = "27017"
host = f"mongodb://{username}:{pwd}@{hostname}:{port}/{db_name}?authSource=admin".format(username=username, pwd=pwd, hostname=hostname,
                                                                                         db_name=db_name, port=port)

DATABASES = {'default': {'ENGINE': 'djongo', 'NAME': 'lol_stats', 'CLIENT': {'host': host}}}
...
GRAPHENE = {'SCHEMA': 'lol_stats.schema.schema', 'MIDDLEWARE': ['graphql_jwt.middleware.JSONWebTokenMiddleware', ], }
